...
-- what data you need : ingredients's name, suppliers's name, ingredients_id, supplier_id 
-- which table(s) are involved : Ingredients, Suppliers
-- What SQL concepts you plan to use : 
-- 1. Find Ingredients's name and Suppliers's name
-- 2. Join to table that supplier_id needs to match.
-- 3. Then filter for Suppliers where name = 'Freshest Farm Produce'.
